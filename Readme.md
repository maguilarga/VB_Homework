...
* Summ_Stock_Range.vbs - during my research for the homework, I came across some information about how to define subranges out of a bigger range of data. The code works correctly but executes fairly slowly, that is the reason I did NOT bring this code to the final XLSM file.
